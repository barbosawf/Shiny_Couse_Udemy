...
server <- function(input, output) {
  ...
  renderBarChart(div_id = "test_3", grid_left = '3%', data = dat_2, font.size.legend=15,show.tools=FALSE,show.legend = FALSE)
  ...
  renderGauge(div_id = "test_5", gauge_name = "Meta de vendas", rate = 59.9, theme = "infographic")
